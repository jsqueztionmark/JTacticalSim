<Query Kind="Program">
  ...
  <Namespace>JTacticalSim.API.Component.Util</Namespace>
...
void Main()
{
	...
	//TheGame.LoadedScenario.VictoryConditions.Dump();
	
	var attacker = ScriptTestUnits.ANTISUB_FIGHTER;
	var defender = ScriptTestUnits.SubSquad_A;
	
	var r = TheGame.JTSServices.RulesService.UnitCanDoBattleWithUnit(attacker, defender, BattleType.LOCAL);
	r.Dump();
